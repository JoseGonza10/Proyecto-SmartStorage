...
BEGIN
    ...
    COMMIT;
END;
------Funci贸n para Obtener Informaci贸n de un Proveedor:------
...
------Funci贸n para Obtener Informaci贸n de un Cliente:------
...
------Procedimiento Almacenado para Insertar una Categor铆a:------
...
------Procedimiento Almacenado para Actualizar una Categor铆a:------
...
------Procedimiento Almacenado para Eliminar una Categor铆a------
...
------Funci贸n para Obtener Informaci贸n de una Categor铆a:------
...
------Cursor para Obtener Todas las Categor铆as:------
...
------Funci贸n para Obtener Informaci贸n de un Producto:------
...
------Funci贸n para Obtener Informaci贸n de un Empleado:------
...
------Procedimiento Almacenado para Insertar una Posici贸n:------
...
------Procedimiento Almacenado para Actualizar una Posici贸n:------
...
------Procedimiento Almacenado para Eliminar una Posici贸n:------
...
------Funci贸n para Obtener Informaci贸n de una Posici贸n:------
...
------Funci贸n para Obtener Informaci贸n de una factura:------
...
CREATE VIEW V_A袿SXEMPLEADO AS 
SELECT ID_EMPLEADO,NOMBRE_EMPLEADO||PRIMER_APELLIDO_EMPLEADO NOMBRE_COMPLETO,FLOOR
(MONTHS_BETWEEN (CURRENT_DATE,FECHA_CONTRATACION) /12) "A袿S" FROM EMPLEADOS ORDER BY FECHA_CONTRATACION;

SELECT * FROM V_A袿SXEMPLEADO;
