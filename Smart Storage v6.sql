...
------------------------Paquetes------------------------
drop package clientes_package;
CREATE OR REPLACE PACKAGE pkg_clientes AS 

    FUNCTION ObtenerCliente(p_cedula_cliente IN CLIENTES.CEDULA_CLIENTE%TYPE) RETURN SYS_REFCURSOR;
    
    FUNCTION ObtenerTodosClientes RETURN SYS_REFCURSOR;
   ...
   PROCEDURE ActualizarCliente(
    ...
    PROCEDURE llamadaObtenerCliente(refCur out SYS_REFCURSOR,idCliente in CLIENTES.CEDULA_CLIENTE%TYPE);
   
    PROCEDURE llamadaObtenerTodosClientes(refCur out SYS_REFCURSOR); 
...
CREATE OR REPLACE PACKAGE BODY pkg_clientes AS 
    ...
    FUNCTION ObtenerCliente(p_cedula_cliente IN CLIENTES.CEDULA_CLIENTE%TYPE)
    RETURN SYS_REFCURSOR
    AS
        v_cliente SYS_REFCURSOR;
    BEGIN
    ...
    END ActualizarCliente;
       ...
       PROCEDURE EliminarCliente(p_cedula_cliente IN CLIENTES.CEDULA_CLIENTE%TYPE)
    AS
    BEGIN
        DELETE FROM CLIENTES
        WHERE CEDULA_CLIENTE = p_cedula_cliente;
    ...
    END EliminarCliente;  
       ...
       PROCEDURE llamadaObtenerCliente(refCur out SYS_REFCURSOR,idCliente in CLIENTES.CEDULA_CLIENTE%TYPE) AS
    BEGIN
    refCur := ObtenerCliente(idCliente);
    END llamadaObtenerCliente;
    
        PROCEDURE llamadaObtenerTodosClientes(refCur out SYS_REFCURSOR) AS
    BEGIN
    refCur := ObtenerTodosClientes;
    END llamadaObtenerTodosClientes;
...
--------------------------------------------------
drop package proveedores_package;
CREATE OR REPLACE PACKAGE pkg_proveedores AS

    FUNCTION ObtenerTodosProveedores RETURN SYS_REFCURSOR;

    FUNCTION ObtenerProveedor(p_id_proveedor IN PROVEEDORES.ID_PROVEEDOR%TYPE) RETURN SYS_REFCURSOR;
    ...
    PROCEDURE EliminarProveedor(p_id_proveedor IN PROVEEDORES.ID_PROVEEDOR%TYPE);
    
    PROCEDURE llamadaObtenerProveedor(refCur out SYS_REFCURSOR,idProveedor in PROVEEDORES.ID_PROVEEDOR%TYPE);

    PROCEDURE llamadaObtenerTodosProveedores(refCur out SYS_REFCURSOR);
...
CREATE OR REPLACE PACKAGE BODY pkg_proveedores AS
    ...
    FUNCTION ObtenerProveedor(p_id_proveedor IN PROVEEDORES.ID_PROVEEDOR%TYPE)
    RETURN SYS_REFCURSOR
    AS
        v_proveedor SYS_REFCURSOR;
    BEGIN
    ...
    END EliminarProveedor;
        ...
        PROCEDURE llamadaObtenerProveedor(refCur out SYS_REFCURSOR,idProveedor in PROVEEDORES.ID_PROVEEDOR%TYPE) AS
    BEGIN
    refCur := ObtenerProveedor(idProveedor);
    END llamadaObtenerProveedor;
    
        PROCEDURE llamadaObtenerTodosProveedores(refCur out SYS_REFCURSOR) AS
    BEGIN
    refCur := ObtenerTodosProveedores;
    END llamadaObtenerTodosProveedores;
...
--------------------------------------------------
drop package categorias_package;

CREATE OR REPLACE PACKAGE pkg_categorias AS

        FUNCTION ObtenerCategoria(p_id_categoria IN CATEGORIAS.ID_CATEGORIA%TYPE) RETURN SYS_REFCURSOR;

        FUNCTION ObtenerTodasCategorias RETURN SYS_REFCURSOR;
        ...
        PROCEDURE EliminarCategoria(p_id_categoria IN CATEGORIAS.ID_CATEGORIA%TYPE);
        
        PROCEDURE llamadaObtenerCategoria(refCur out SYS_REFCURSOR,idCategoria in CATEGORIAS.ID_CATEGORIA%TYPE);
    
        PROCEDURE llamadaObtenerTodasCategorias(refCur out SYS_REFCURSOR);
...
CREATE OR REPLACE PACKAGE BODY pkg_categorias AS
    ...
    FUNCTION ObtenerCategoria(p_id_categoria IN CATEGORIAS.ID_CATEGORIA%TYPE)
    RETURN SYS_REFCURSOR
    AS
        v_categoria SYS_REFCURSOR;
    BEGIN
    ...
    END EliminarCategoria;
        ...
        PROCEDURE llamadaObtenerCategoria(refCur out SYS_REFCURSOR,idCategoria in CATEGORIAS.ID_CATEGORIA%TYPE) AS
    BEGIN
    refCur := ObtenerCategoria(idCategoria);
    END llamadaObtenerCategoria;
    
        PROCEDURE llamadaObtenerTodasCategorias(refCur out SYS_REFCURSOR) AS
    BEGIN
    refCur := ObtenerTodasCategorias;
    END llamadaObtenerTodasCategorias;
...
------------------------Productos ------------------------------------
drop package package_productos;

CREATE OR REPLACE PACKAGE pkg_productos AS

        FUNCTION ObtenerProducto(p_id_producto IN PRODUCTOS.ID_PRODUCTO%TYPE) RETURN SYS_REFCURSOR;
        
        FUNCTION ObtenerTodosProductos RETURN SYS_REFCURSOR;
        ...
        PROCEDURE EliminarProducto(p_id_producto IN PRODUCTOS.ID_PRODUCTO%TYPE);
        
        PROCEDURE llamadaObtenerProducto(refCur out SYS_REFCURSOR,idProducto in PRODUCTOS.ID_PRODUCTO%TYPE);
        
        PROCEDURE llamadaObtenerTodosProductos(refCur out SYS_REFCURSOR);
...
CREATE OR REPLACE PACKAGE BODY pkg_productos AS
    ...
    FUNCTION ObtenerProducto(p_id_producto IN PRODUCTOS.ID_PRODUCTO%TYPE)
    RETURN SYS_REFCURSOR
    AS
        v_producto SYS_REFCURSOR;
    BEGIN
    ...
    PROCEDURE llamadaObtenerTodosProductos(refCur out SYS_REFCURSOR) AS
    BEGIN
    refCur := ObtenerTodosProductos;
    END llamadaObtenerTodosProductos;
    
    PROCEDURE llamadaObtenerProducto(refCur out SYS_REFCURSOR,idProducto in PRODUCTOS.ID_PRODUCTO%TYPE) AS
    BEGIN
    refCur := ObtenerProducto(idProducto);
    END llamadaObtenerProducto;
...
-------------------------Facturacion-----------------------------------
drop package package_facturacion;

CREATE OR REPLACE PACKAGE pkg_facturacion AS

    FUNCTION ObtenerFactura(p_id_factura IN FACTURACION.ID_FACTURA%TYPE) RETURN SYS_REFCURSOR;

    FUNCTION ObtenerTodasFacturas RETURN SYS_REFCURSOR;
    ...
    PROCEDURE EliminarFactura(p_id_factura IN FACTURACION.ID_FACTURA%TYPE);
    
    PROCEDURE llamadaObtenerFactura(refCur out SYS_REFCURSOR,idFactura in FACTURACION.ID_FACTURA%TYPE);
    
    PROCEDURE llamadaObtenerTodasFacturas(refCur out SYS_REFCURSOR);
...
CREATE OR REPLACE PACKAGE BODY pkg_facturacion AS
    ...
    FUNCTION ObtenerFactura(p_id_factura IN FACTURACION.ID_FACTURA%TYPE)
    RETURN SYS_REFCURSOR
    AS
        v_factura SYS_REFCURSOR;
    BEGIN
    ...
    END EliminarFactura;
        ...
        PROCEDURE llamadaObtenerFactura(refCur out SYS_REFCURSOR,idFactura in FACTURACION.ID_FACTURA%TYPE) AS
    BEGIN
    refCur := ObtenerFactura(idFactura);
    END llamadaObtenerFactura;
    
        PROCEDURE llamadaObtenerTodasFacturas(refCur out SYS_REFCURSOR) AS
    BEGIN
    refCur := ObtenerTodasFacturas;
    END llamadaObtenerTodasFacturas;
...
drop package package_posicion;

CREATE OR REPLACE PACKAGE pkg_posicion AS

    FUNCTION ObtenerPosicion(p_id_posicion IN POSICION.ID_POSICION%TYPE) RETURN SYS_REFCURSOR;
    
    FUNCTION ObtenerTodasPosiciones RETURN SYS_REFCURSOR;

    PROCEDURE InsertarPosicion(
    p_posicion IN POSICION.POSICION%TYPE,
    p_id_posicion IN POSICION.ID_POSICION%TYPE
    );
    
    PROCEDURE ActualizarPosicion(
    p_id_posicion IN POSICION.ID_POSICION%TYPE,
    p_nueva_posicion IN POSICION.POSICION%TYPE
    );
    
    PROCEDURE EliminarPosicion(p_id_posicion IN POSICION.ID_POSICION%TYPE);
    
    PROCEDURE llamadaObtenerPosicion(refCur out SYS_REFCURSOR,idPosicion in POSICION.ID_POSICION%TYPE);
    
    PROCEDURE llamadaObtenerTodasPosiciones(refCur out SYS_REFCURSOR);
...
CREATE OR REPLACE PACKAGE BODY pkg_posicion AS

        FUNCTION ObtenerPosicion(p_id_posicion IN POSICION.ID_POSICION%TYPE)
    RETURN SYS_REFCURSOR
    AS
        v_posicion SYS_REFCURSOR;
    BEGIN
    ...
    END ObtenerPosicion;
        ...
        FUNCTION ObtenerTodasPosiciones
    RETURN SYS_REFCURSOR
    AS
        v_cursor SYS_REFCURSOR;
    BEGIN
    ...
    END EliminarPosicion;
        ...
        PROCEDURE llamadaObtenerPosicion(refCur out SYS_REFCURSOR,idPosicion in POSICION.ID_POSICION%TYPE) AS
    BEGIN
    refCur := ObtenerPosicion(idPosicion);
    END llamadaObtenerPosicion;
    
        PROCEDURE llamadaObtenerTodasPosiciones(refCur out SYS_REFCURSOR) AS
    BEGIN
    refCur := ObtenerTodasPosiciones;
    END llamadaObtenerTodasPosiciones;
...
drop package empleados_package;

CREATE OR REPLACE PACKAGE pkg_empleados AS 

FUNCTION ObtenerEmpleado(p_id_empleado IN EMPLEADOS.ID_EMPLEADO%TYPE) RETURN SYS_REFCURSOR;

FUNCTION ObtenerTodosEmpleados RETURN SYS_REFCURSOR;
...
PROCEDURE EliminarEmpleado(p_id_empleado in EMPLEADOS.ID_EMPLEADO%TYPE);

PROCEDURE llamadaObtenerEmpleado(refCur out SYS_REFCURSOR,idEmpleado in EMPLEADOS.ID_EMPLEADO%TYPE);

PROCEDURE llamadaObtenerTodosEmpleados(refCur out SYS_REFCURSOR);
...
CREATE OR REPLACE PACKAGE BODY pkg_empleados AS 
    ...
    FUNCTION ObtenerEmpleado(p_id_empleado IN EMPLEADOS.ID_EMPLEADO%TYPE)
    RETURN SYS_REFCURSOR
    AS
        v_empleado SYS_REFCURSOR;
    BEGIN
...
PROCEDURE llamadaObtenerEmpleado(refCur out SYS_REFCURSOR,idEmpleado in EMPLEADOS.ID_EMPLEADO%TYPE) AS
BEGIN
refCur := ObtenerEmpleado(idEmpleado);
END llamadaObtenerEmpleado;

PROCEDURE llamadaObtenerTodosEmpleados(refCur out SYS_REFCURSOR) AS
BEGIN
refCur := ObtenerTodosEmpleados;
END llamadaObtenerTodosEmpleados;
